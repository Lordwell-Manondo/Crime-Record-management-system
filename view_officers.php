...
<body>
    ...
    <form method="post" action="" style="margin-left: 0;">
      <input type="text" name="employee_number" placeholder="search by mployee number">
        <input type="submit" name="search" value="Search">
      </form>

      <a class="logout-link" href="Admin_landing_page.html" class="logout-link">
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16" style="margin-left: 15px;">
