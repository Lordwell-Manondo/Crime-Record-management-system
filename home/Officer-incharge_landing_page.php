    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item dropdown">
                    <a  class="nav-link" style="color: white;" href="#"  id="casesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Cases 
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" style="color: white;" href="#" id="officersDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Officers
                    <i class="fas fa-angle-down"   style="margin-left: 5px;  color: white; font-size: small; font-weight: 550;"></i> 
                   </a>
                    ...
                    <li class="nav-item dropdown">
                    <a  class="nav-link" style="color: white;" href="#"  id="dutiesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Duties
                    <i class="fas fa-angle-down"   style="margin-left: 5px;  color: white; font-size: small; font-weight: 550;"></i>
                    </a>
                    <!-- submenu for duties -->
                    <ul class="dropdown-menu" aria-labelledby="submenu">
                    <li><a class="dropdown-item" style="margin-left: 0%;" href="../duty/assign_duty.php">Assign duties</a>
                   </li>
                    ...
                    <!-- submenu for profile -->
                    <ul class="dropdown-menu" aria-labelledby="submenu">
                    <li><a class="dropdown-item" style="margin-left: 0%; font-size: 100%;  " href="../changepass/change-password-admin.php">Change password</a></li>
