          ...
          <header>
            ...
            <li style="margin-left: 10px;">
              <a class="nav-link" href="../Notifications.php">
                ...
                <p style="font-size: 15px; margin-left: -20px; color: rgb(19, 17, 17); ">Notifications  </p>
                
              </a>
            </li>
                    
                <li class="nav-item dropdown"  style="margin-left: 30px;margin-top: -15px;  color: rgb(19, 17, 17);">
                <a class="nav-link" href="#"  ><svg  class="login" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16" >
                        ...
                        <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                          ...
                          <p style="font-size: 15px; margin-left: -5px; color: rgb(19, 17, 17);">Account</p>
                          ...
                          <a href="logout.php"> <svg class="logout"  xmlns="http://www.w3.org/2000/svg" width="30" height="35" fill="red" class="bi bi-box-arrow-right" viewBox="0 0 16 16" style="margin-left: 105px;">
