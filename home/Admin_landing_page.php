          ...
          <header>
            ...
            <li style="margin-left: 10px;">
              <a class="nav-link" href="../Notifications.php">
                <svg class="notification" xmlns="http://www.w3.org/2000/svg" style="margin-top: -15px;" width="25" height="25" fill="currentColor" class="bi bi-bell-fill" viewBox="0 0 16 16">
                  <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z"/>
                </svg><span class="badge badge-danger">2</span>
                <p style="font-size: 15px; margin-left: -20px; ">Notifications  </p>
                
              </a>
            </li>
                    
                <li class="nav-item dropdown"  style="margin-left: 30px;margin-top: -15px; font-weight: lighter;">
                <a class="nav-link" href="#"  ><svg  class="login" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16" >
                        ...
                        <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                          ...
                          <p style="font-size: 15px; margin-left: -5px;">Account</p>
                        
                          
                            <a   style="margin-left: 99px; margin-top: -55px;" class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"   style="color: rgb(19, 17, 17); margin-left: 1px;">
                            </a>   
                          ...
                          <a href="Home.php"> <svg class="logout"  xmlns="http://www.w3.org/2000/svg" width="30" height="35" fill="red" class="bi bi-box-arrow-right" viewBox="0 0 16 16" style="margin-left: 105px;">
                            <path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"/>
                            <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
                          </svg> <p style="font-size: 13px; color: black; margin-left: 105px; font-weight: 15px;">Logout</p></a>
                      </div>
